...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        # self.epsilon = (self.eps_begin - self.eps_end)*(1-t/self.nsteps) + self.eps_end
        self.epsilon = max(self.eps_end, self.eps_begin - (self.eps_begin - self.eps_end) * t / self.nsteps)
        ##############################################################
        ######################## END YOUR CODE ############## ########
